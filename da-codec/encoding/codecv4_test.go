...
func TestCodecV4NewDABatchFromBytes(t *testing.T) {
	codecv4, err := CodecFromVersion(CodecV4)
	require.NoError(t, err)
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.jsonFile == "" {
				...
				daBatch, createErr1 = codecv4.NewDABatch(batch)
			...
			decodedDABatch, createErr2 := codecv4.NewDABatchFromBytes(encodedBytes)
	...
	encodedBytes := daBatch.Encode()
	decodedDABatch, err := codecv4.NewDABatchFromBytes(encodedBytes)
	assert.NoError(t, err)
...
func TestCodecV4BlobEncodingAndHashing(t *testing.T) {
	...
	assert.Equal(t, common.HexToHash("0x01e5c897e0f98f6addd6c99bb51ff927cde93851b0d407aae3d7d5de75a31f29"), daBatch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x01ad8c8eee24cc98ab1ca9c0a4c92bf20f488f06dedbc22f1312bd389df71050"), daBatch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x01c6a9a7d06425dbfad42697e4ce5bc8562d7c5ffe1f62d57fcb51240e33af93"), daBatch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x016ac24dabb9e1bbb3ec3c65b50a829564c2f56160ba92fbdb03ed7e4a0c439a"), daBatch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x0128a4e122c179a7c34ab1f22ceadf6fa66d2bb0d229933fe1ed061dd8b1fb5f"), daBatch.(*daBatchV3).blobVersionedHash)
	...
	assert.Equal(t, common.HexToHash("0x0121388d141bd439af8447db5d00bacbfe1587fea6581f795e98588d95ba7f26"), daBatch.(*daBatchV3).blobVersionedHash)
}
...
func TestCodecV4BatchCompressedDataCompatibilityCheck(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Multiple Blocks And Chunks", []string{"testdata/blockTrace_02.json", "testdata/blockTrace_03.json", "testdata/blockTrace_04.json", "testdata/blockTrace_05.json", "testdata/blockTrace_06.json", "testdata/blockTrace_07.json"}, true},
	}
